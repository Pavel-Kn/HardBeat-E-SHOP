...
import { getProducts, getProductsLoadingStatus, getFilteredProducts } from "../../store/products";
...
const ProductsList = () => {
    ...
    const filteredList = useSelector(getFilteredProducts()); // это лист для мега фильтрации. Нужно его использовать вместо productsList
